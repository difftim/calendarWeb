...
const tokens = {
  ...
  // Dark theme colors (aligned with variables.scss)
  dswColorBackground1Dark: '#181a20',
  dswColorBackground2Dark: '#1e2329',
  dswColorBackground4Dark: '#474d57',
  dswColorBackgroundModalDark: '#2b3139',
  dswColorBackgroundPopupDark: '#1e2329',
  dswColorBackgroundDisableDark: '#474d57',
  dswColorBackgroundTooltipDark: '#5e6673',
  dswColorTextPrimaryDark: '#eaecef',
  dswColorTextThirdDark: '#848e9c',
  dswColorTextDisableDark: '#5e6673',
  dswColorTextInfoDark: '#82c1fc',
  dswColorLineDark: '#474d57',
  dswColorPrimaryDark: '#056ffa',
